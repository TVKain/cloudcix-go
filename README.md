...
<a href="https://pkg.go.dev/github.com/stainless-sdks/cloudcix-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/cloudcix-go.svg" alt="Go Reference"></a>

<!-- x-release-please-end -->

The Cloudcix Go library provides convenient access to the [Cloudcix REST API](https://compute.api.cloudcix.com/documentation/)
...
```go
import (
	"github.com/stainless-sdks/cloudcix-go" // imported as cloudcix
)
```
...
```sh
go get -u 'github.com/stainless-sdks/cloudcix-go@v0.0.1'
```
...
The cloudcix library uses the [`omitzero`](https://tip.golang.org/doc/go1.24#encodingjsonpkgencodingjson)
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/cloudcix-go/option).
...
`*cloudcix.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `cloudcix.File(reader io.Reader, filename string, contentType string)`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/cloudcix-go/issues) with questions, bugs, or suggestions.
