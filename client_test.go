...
import (
	...
	"github.com/stainless-sdks/cloudcix-go/internal"
...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Compute.Backups.List(context.Background(), cloudcix.ComputeBackupListParams{})
	if userAgent != fmt.Sprintf("Cloudcix/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Compute.Backups.List(context.Background(), cloudcix.ComputeBackupListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Compute.Backups.List(cancelCtx, cloudcix.ComputeBackupListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Compute.Backups.List(deadlineCtx, cloudcix.ComputeBackupListParams{})
		if err == nil {
